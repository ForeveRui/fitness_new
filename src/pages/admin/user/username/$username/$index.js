...
class Index extends React.Component {
    ...
    onChange = (e) => {
        ...
        pos = pos.pathname.split('/');
        router.push(`/admin/user/username/${pos[4]}/${e}`);
    }
    ...
    confirm = (uid) => {
        ...
        dispatch({
            type: 'username/deleteUser',
            payload: {
                obj: obj,
                page: location.pathname.split('/')[5],
                username: location.pathname.split('/')[4]
            }
        })
    }
...
function mapStateToProps(state) {
    const { UserNum, UserList } = state.username
    return {
        loading: state.loading.models.username,
        UserNum,
        UserList
    }
}
